...
from www.common.web.user import cookie2user
from www.const import COOKIE_NAME
...
async def init():
    ...
    app = web.Application(middlewares=[logger_factory, auth_factory, response_factory])  # middlewares是拦截器
